                ...
                <div ref={infoRef} className="space-y-16">
                  ...
                  <div className="space-y-8">
                    <div className="info-anim group cursor-pointer">
                      <h3 className="text-xs font-mont font-bold tracking-[0.2em] uppercase text-white/40 mb-2">Email</h3>
                      <a href="mailto:connect@bravild.in" className="text-xl md:text-2xl font-serif text-white/90 group-hover:text-white transition-colors flex items-center gap-3 font-normal">
                        connect@bravild.in
                    ...
                    <div className="info-anim group cursor-pointer">
                      <h3 className="text-xs font-mont font-bold tracking-[0.2em] uppercase text-white/40 mb-2">Phone</h3>
                      <a href="tel:+919664086233" className="text-xl md:text-2xl font-serif text-white/90 group-hover:text-white transition-colors flex items-center gap-3 font-normal">
                        +91 9664086233
                        <ArrowRight className="w-5 h-5 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
                      </a>
                    </div>

                    <div className="info-anim group">
                      <h3 className="text-xs font-mont font-bold tracking-[0.2em] uppercase text-white/40 mb-2">Socials</h3>
                      <div className="flex flex-wrap gap-6">
                        {[
                          { name: 'LinkedIn', url: 'https://www.linkedin.com/in/jayditya-sharma-35ab14420' },
                          { name: 'Twitter', url: 'https://x.com/Jayditya_sharma' },
                          { name: 'Instagram', url: 'https://www.instagram.com/jayu_._sharma/' }
                        ].map((social) => (
                          <a
                            key={social.name}
                            href={social.url}
                            ...
                            className="text-base font-serif text-white/90 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[1px] after:bg-white hover:after:w-full after:transition-all after:duration-300 font-normal"
                          >
                            {social.name}
                          </a>
                        ))}
                  ...
                  <div className="info-anim pt-12 border-t border-white/10">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-gray-600 font-serif">
